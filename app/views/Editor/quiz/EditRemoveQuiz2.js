...
import {createQuiz, editQuiz} from "../../../services/quiz/quizFuncs";
...
export default class CreateQuiz extends Component {
    ...
    handleSubmit() {
        ...
        editQuiz(this.state.id, this.state.title, this.state.description, questionIds, this.state.publish ,this.state.token)
            .then((data) => {
                console.log(data);
                this.setState({loading: false})
                this.props.navigation.replace('QuizConfirm', {type: 'modified'});
            })
            .catch((error) => {
